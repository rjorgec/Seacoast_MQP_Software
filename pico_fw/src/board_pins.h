...
#ifndef PICO_UART_ID
#define PICO_UART_ID        1      // 0 = uart0, 1 = uart1
#endif
...
#define PICO_UART_TX_GPIO   -1     // set later (e.g. 4)
#endif
...
#define DRV8163_CTRL_A_GPIO  -1    // PWM capable GPIO
#endif

#ifndef DRV8163_CTRL_B_GPIO
#define DRV8163_CTRL_B_GPIO  -1    // PWM capable GPIO
#endif

#ifndef DRV8163_SENSE_GPIO
#define DRV8163_SENSE_GPIO   -1    // ADC-capable GPIO (commonly 26/27/28 on RP2040-style)
#endif
...
#define DRV8163_DEFAULT_LOW_TH 0
#endif

#ifndef DRV8163_DEFAULT_HIGH_TH
#define DRV8163_DEFAULT_HIGH_TH 4095
#endif

#ifndef DRV8163_DEFAULT_STARTUP_BLANKING_MS
#define DRV8163_DEFAULT_STARTUP_BLANKING_MS 0
#endif

#ifndef DRV8163_DEFAULT_CHECK_INTERVAL_MS
#define DRV8163_DEFAULT_CHECK_INTERVAL_MS 50
#endif
